...
public class FakeFilterChain implements FilterChain {
	...
	private static Queue<Filter> filterQueue;
	private static Queue<Filter> filterQueueTemp;
	...
	public FakeFilterChain() {
		...
		this.filterQueueTemp = new SimpleQueue<Filter>();
	...
	public void setFilters(Filter... filters) {
		...
		for (Filter filter : filters) {
			this.filterQueueTemp.offer(filter);
		}
	}
	...
	public static Queue<Filter> getFilters(){
		return filterQueueTemp;
	}
