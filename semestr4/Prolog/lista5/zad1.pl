...
set_types([First|L], Curr_types, Final_types):-
    ...
    ;   string_length(First,N), N1 is N-1, sub_atom(First,0,N1,_,P1), sub_atom(First,_,1,0,P2),atom_string(P1,K1), atom_string(P2,K2),
        (type(K1,Fin);type_int(K1,Fin);(id(K1)->type_id(K1,Fin))), (type(K2,Fin2);type_int(K2,Fin2); (   id(K2)->type_id(K2,Fin2))),
